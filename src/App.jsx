...
const recommendationLetters = [
  {
    ...
    subtitle: "Assistant Professor, Dental Hygiene Program",
    organization: "St. Louis Community College",
    author: "Julie Dermody, RDH, BSDH, MA",
    paragraphs: [
      "I am pleased to offer this letter of recommendation for my student, Parmila Khapangi. Parmila is enrolled as a full-time student in the Dental Hygiene Program at St. Louis Community College. Upon completion of the Dental Hygiene Program, Parmila will earn the degree of Associate of Applied Science in Dental Hygiene in May 2026.",
      "I have had the pleasure of having Parmila as a student in the courses I teach at STLCC. Parmila is a very hard-working student. She maintains excellent grades and always completes assignments thoroughly and on time. Parmila is always cooperative in labs and classroom activities and assists others in class and clinic as well.",
      "Parmila's attention to detail and hard work ethic not only make her an exceptional student in the classroom, but these assets also assist her in her clinical time as a dental hygiene student. Parmila has excellent clinical skills, great rapport with her patients, and a team-centered work ethic.",
      "She is prepared for her clinical duties and on-site rotations, and she is happy to help others in a variety of situations. Parmila's hard work, determination, and cooperation are evident in all she does, and they will serve her well in her future career as a dental hygienist. It is without any reservation that I recommend Parmila Khapangi for your consideration for a dental hygiene position.",
    ],
  },
  {
    title: "Letter of Reference",
    subtitle: "Plant Transformation Plugging Lead",
    organization: "Bayer Crop Science",
    author: "Megan Hassebrock",
    paragraphs: [
      "I am writing to offer my strong and enthusiastic recommendation for Parmila Khapangi, whom I had the pleasure of working with at Bayer Crop Science during her time as a contract biologist. Parmila was an exceptional employee who consistently demonstrated professionalism, responsibility, and a proactive approach to her work.",
      "She was always willing to learn, eager to take on new challenges, and dependable in following through on tasks. No matter the situation, Parmila approached her responsibilities with care, attention to detail, and a genuine desire to do her best.",
      "One of Parmila's greatest strengths was her leadership in the lab. She naturally led by example, setting a high standard for others through her work ethic, accountability, and positive attitude. Other employees looked to her as a role model, and she was always supportive and encouraging to her teammates.",
      "Parmila also brought an incredible energy to the workplace. She consistently maintained a positive attitude and a warm smile, which made her a joy to work with and contributed to a collaborative and uplifting team environment. I am confident that Parmila will be a valuable asset to any organization and recommend her without hesitation.",
    ],
  },
];
        ...
        <section id="recommendations" className="content-section">
          <div className="container">
            <div className="section-heading-wrap">
              ...
              <h2 className="section-heading">Letters of Recommendation</h2>
            </div>
            <div className="row g-4">
              {recommendationLetters.map((letter) => (
                <div className="col-md-6" key={letter.title}>
                  <article className="feature-card recommendation-card h-100">
                    <h3>{letter.title}</h3>
                    <p className="recommendation-author">{letter.author}</p>
                    <p className="recommendation-subtitle">{letter.subtitle}</p>
                    <p className="recommendation-org">{letter.organization}</p>
